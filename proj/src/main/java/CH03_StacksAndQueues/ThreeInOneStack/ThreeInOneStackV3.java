...
public class ThreeInOneStackV3<T> {
    // aggregate
    private final AutoScaleMultiInOneStack<T> multiInOneStack;

    public ThreeInOneStackV3(int defaultCapacity) {
        this.multiInOneStack = new AutoScaleMultiInOneStack<>(3, defaultCapacity);
    }
